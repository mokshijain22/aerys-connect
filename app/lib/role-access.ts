export const ROLE_ACCESS: Record<string, string[]> = {
  super_admin: ['/', '/vehicles', '/jobcards', '/warranty-claims', '/warranty-check', '/reports', '/dealers', '/technicians', '/inventory', '/analytics', '/settings'],
  dealer: ['/', '/vehicles', '/jobcards', '/warranty-claims', '/warranty-check', '/technicians', '/inventory'],
